...
export default function BeforeAfter() {
  ...
  return <section className="case-section shell section" id="work" aria-labelledby="cases-title">
    ...
    <p className="case-disclosure">Демонстрационные примеры: изображения созданы с помощью ИИ и не являются фотографиями выполненных заказов Cleania. Они показывают типовые задачи, а не гарантируют результат на конкретном объекте. Реальные кейсы добавим после съёмки и согласия клиентов.</p>
  </section>;
}
