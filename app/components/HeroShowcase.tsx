...
export default function HeroShowcase() {
  ...
  const isBusinessProperty = propertyType === "commercial" || propertyType === "industrial";
  ...
  return (
    <section className="home-hero shell" aria-labelledby="hero-title">
      <div className="hero-title-row">
        ...
        <div className="hero-aside"><CleaningSpark /><div className="hero-aside-copy"><p>Уборку возьмём на себя. Выберите, как провести освободившийся день.</p><a href="#calculator" className="text-link">Рассчитать мою уборку</a></div></div>
      </div>
      <div className="home-hero-photo">
        ...
        <div className="quick-quote">
          ...
          <div className="quick-quote-bottom"><div><small>Предварительно</small><strong><PriceAmount amount={quote.total} /></strong></div><a href="#calculator" aria-label="Настроить уборку в калькуляторе">Настроить</a></div>
        </div>
        {!isBusinessProperty && <span className="photo-caption">Всё для уютного возвращения домой</span>}
      </div>
