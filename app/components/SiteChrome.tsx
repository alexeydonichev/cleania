...
export function PublicHeader() {
  return <><header className="site-header">
    ...
    <details className="mobile-menu"><summary aria-label="Открыть меню"><span /><span /></summary><nav aria-label="Мобильная навигация"><Link href="/#services">Услуги</Link><Link href="/#calculator">Рассчитать стоимость</Link><Link href="/#included">Что входит в уборку</Link><Link href="/#quality">Как работаем</Link><Link href="/#work">До и после</Link><Link href="/#faq">Вопросы</Link><Link href="/business">Для бизнеса</Link><Link href="/contacts">Telegram, MAX и контакты</Link><a href={`tel:${contactPhone}`}>{contactPhoneDisplay}</a></nav></details>
  </header><MotionDesign /></>;
}
