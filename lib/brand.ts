...
// PNG keeps an explicit image MIME type through the current static host; the navigation uses the exact smaller rendition below.
export const brandLogo = { src: "/brand/bleskpro-logo-blue.png", width: 1786, height: 406 } as const;
export const brandHeaderLogo = { src: "/brand/bleskpro-logo-blue-640.png", width: 640, height: 145 } as const;
